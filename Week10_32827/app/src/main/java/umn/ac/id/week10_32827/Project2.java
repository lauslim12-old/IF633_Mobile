...
public class Project2 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Void> {
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        static WeakReference<Project2> mActivity;
        int mCounter = 0;

        public ContohLoader(@NonNull Context context, int n, Project2 main) {
            super(context);
            mCounter = n;
            mActivity = new WeakReference<Project2>(main);
        }
