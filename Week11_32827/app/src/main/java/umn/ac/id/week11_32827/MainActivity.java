package umn.ac.id.week11_32827;
        ...
        dataCall.enqueue(new Callback<ArrayList<Data>>() {
            ...
            public void onResponse(@NonNull Call<ArrayList<Data>> call, @NonNull Response<ArrayList<Data>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Snackbar.make(mainLayout, getString(R.string.success_fetch), Snackbar.LENGTH_LONG).show();
                } else {
                    Snackbar.make(mainLayout, getString(R.string.get_fail), Snackbar.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<ArrayList<Data>> call, @NonNull Throwable t) {
                ...
                Snackbar.make(mainLayout, getString(R.string.internal_error), Snackbar.LENGTH_LONG).show();
            }
        });
    }
}